        ...
        <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
          <div className='bg-white pt-8 pb-12 px-4 shadow sm:rounded-lg sm:px-10 text-default-primary'>
            <form className='space-y-6' action='#' method='POST'>
              ...
              <button className='  w-full bg-default-primary text-white py-4 px-8 rounded-md mt-5 font-semibold focus:outline-none focus:ring-default-primary focus:border-default-primary '>
                LOG IN
              </button>
            </form>
          </div>
